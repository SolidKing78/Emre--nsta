...
- **Etkileşimi artır (kadranlar):** Profesyonel pano ⚙ → "Etkileşimi artır", Senaryo Laboratuvarı'ndaki kart veya Gönderi istatistikleri ⋯ menüsü. Beş kadran — Takipçi · İzlenme · Görüntülenme · Beğeni · Yorum — her biri kendi yüzdesiyle ayarlanır (`services/simulation/boost.ts`). Kadranlar **bağlaşıktır**: bir kadranı artırınca diğer bütün metrikler gerçekçi oranlarda onunla birlikte yükselir. Model: her ayarlı kadran hesaptaki toplam ilgide bir artış ima eder (beğeni +%100 ≈ ilgi +%80; görüntülenme/izlenme 1:1, yorum ×0,7, takipçi ×0,6), sinyaller birleştirilir (en güçlüsü önder, diğerleri çeyrek ekler — iki +%100 kadran +%200 etmez), sonra ayarlanmamış her metrik büyüme oranıyla aynı esneklik tablosundan bu ilgiyi izler (görüntülenme ×1, yorum ×0,9, paylaşım ×1,05, kaydetme ×1,15, erişim ×0,85, profil ziyareti ×0,6, takipçi ×0,3, yeni takipçi ×1,3). Etkileşim toplamı = beğeni/yorum/paylaşım/kaydetme değişimlerinin ortalaması. Örnek: beğeni +%100 → görüntülenme +%80, yorum +%72, paylaşım +%84, kaydetme +%92, erişim +%68, takipçi +%24. Kadranın doğrudan adlandırdığı metrik tam o yüzde kadar değişir; elle düzenlenen metrik her zaman önce gelir; büyüme oranı da bir sinyal olarak katılır.
- **Senaryo araçları:** Profesyonel pano → sağ üstteki ⚙ (Senaryo modu anahtarı, Etkileşimi artır, Büyüme oranı, Senaryo Laboratuvarı, Önce/Sonra, Growth Lab, Hesap özeti). Metriklere uzun basarak da düzenlenir; Gönderi istatistikleri ekranında ⋯ menüsü aynı araçları sunar. Instagram ekranlarında başka ekstra kontrol yoktur.
